...
def company_header(company_name, company_logo_url, company_rut, company_address, delivery_date, styles):
    ...
    if logo:
        header = Table([[logo, metadata, name]], colWidths=[32 * mm, 62 * mm, 92 * mm], hAlign="CENTER")
        ...
        return header
    return Table([[metadata, name]], colWidths=[76 * mm, 110 * mm], hAlign="CENTER", style=TableStyle([
        ("VALIGN", (0, 0), (-1, -1), "MIDDLE"),
        ("ALIGN", (0, 0), (-1, -1), "CENTER"),
        ("LEFTPADDING", (0, 0), (-1, -1), 1 * mm),
        ("RIGHTPADDING", (0, 0), (-1, -1), 1 * mm),
